...
VL_ATTR_COLD void VCounter___024root___stl_sequent__TOP__0(VCounter___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.out = vlSelfRef.Counter__DOT__cnt;
}
...
VL_ATTR_COLD void VCounter___024root___ctor_var_reset(VCounter___024root* vlSelf) {
    ...
    vlSelf->max = VL_SCOPED_RAND_RESET_I(9, __VscopeHash, 6876800770998467987ull);
    vlSelf->out = VL_SCOPED_RAND_RESET_I(9, __VscopeHash, 7519490245117619040ull);
    vlSelf->Counter__DOT__cnt = VL_SCOPED_RAND_RESET_I(9, __VscopeHash, 15171458607659219782ull);
